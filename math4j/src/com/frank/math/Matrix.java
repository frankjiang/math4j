...
public class Matrix extends SerializableMatrix<Double>
{
	 ...
	 * @see com.frank.math.AbstractMatrix#subMatrix(int[], int, int)
	 */
	@Override
	 ...
	 * @see com.frank.math.AbstractMatrix#subMatrix(int, int, int, int)
	 */
	@Override
	 ...
	 * 
	 * @see com.frank.math.AbstractMatrix#value(int, int)
	 */
	@Override
